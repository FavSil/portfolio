    ...
    <Layout home>
      ...
      <div class="grid grid-cols-4 ">
        <p className="text-gray-900 col-span-2 text-right text-lg font-medium">
          Hi! My name is Favian. I'm a software engineer with a passion for{" "}
        ...
        <p className="text-gray-900 col-span-2 pt-10 text-right text-lg font-medium  md:col-start-2 md:col-span-3 ">
          ...
          beautiful and functional. My recent explorations have been with WEB3.0
          and generative code art in the form of compute shaders. I will be
          posting these soon.
        </p>
      </div>
